/**
 * @class sokoban2sat_forbiddenPositions_reachability_ordering_cnf_parallel
 * @author Miquel Bofill and Cristina Borralleras
 * @version 1.1
 * @date 2023-04-11
 * @brief Translation of a "Sokoban" instance to CNF, with ST reachability (without move actions), ensuring acyclicity with a strict partial order, parallel version 
*/
...
public class sokoban2sat_forbiddenPositions_reachability_ordering_cnf_parallel {
